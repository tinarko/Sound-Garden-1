...
// import * as d3.bullet from '../bullet.js';

var d3BulletChart = {};

d3BulletChart.create = (el, props) => {

  // var svg = d3. select(el).append('svg')
  // .attr('class', 'd3')
  // //may need to change width and height
  // .attr('width', 1000)
  // .attr('height', 1000)
  console.log('props in d3BulletChart', props);
...
if (props.budget.budgets.length > 0) {
  ...
  for (var i = 0; i < props.budget.budgets.length; i++) {
    data.push({'title': props.budget.budgets[i].name, 'subtitle': '$', 'ranges': [150,225,300],'measures':[220,270],'markers':[250] });
  }
