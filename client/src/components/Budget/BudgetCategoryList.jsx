    ...
    return (
      <div className ='budgetlist'>
        <div className = 'totals'>
          <div>
            <p className='budgetTitle'>Total Spent: <span>${this.props.budget.totalSpent}</span></p>
          </div>
          <div>
            <p className='budgetTitle'>Total Budget: <span>${this.props.budget.totalBudget}</span></p>
          </div>
        </div>
        <br />
        <br />
